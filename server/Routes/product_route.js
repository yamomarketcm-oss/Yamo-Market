...
import { createProduct, deleteProduct, getAllProducts, getsProductId, getsProductShopId, getsProductSlug, updateProduct } from "../Controllers/productcontroller.js"
...
router.get('/getproductslug/:slug', getsProductSlug)
